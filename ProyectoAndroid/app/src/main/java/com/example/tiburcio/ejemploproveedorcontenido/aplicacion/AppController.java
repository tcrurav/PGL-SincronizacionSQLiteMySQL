package com.example.tiburcio.ejemploproveedorcontenido.aplicacion;
...
public class AppController extends Application {
    ...
    public static final String ACCOUNT_TYPE = "com.example.tiburcio.ejemploproveedorcontenido";
    // The account name
